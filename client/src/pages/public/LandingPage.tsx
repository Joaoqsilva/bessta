...
const testimonials = [
    {
        ...
        avatar: 'CS',
        content: 'O Bessta transformou meu negócio! Reduzi 80% do tempo que gastava no telefone marcando horários.',
        rating: 5,
    },
    {
                        ...
                        <div className="hero-image-container">
                            ...
                            <div className="hero-dashboard-preview">
                                <div className="preview-header">
                                    ...
                                    <span className="preview-url">bessta.app/dashboard</span>
                                </div>
                    ...
                    <div className="cta-card">
                        <div className="cta-content">
                            ...
                            <p className="cta-description">
                                ...
                                aumentando seus lucros com o Bessta.
                            </p>
